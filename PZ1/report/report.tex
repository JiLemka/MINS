...
\begin{tabular}{|L{3.3cm}|L{5.0cm}|L{7.3cm}|}
\hline
...
\begin{tabular}{|L{4cm}|L{5.3cm}|L{6cm}|}
\hline
...
\small
\setlength{\tabcolsep}{4pt}
\begin{tabular}{|L{3.1cm}|L{1.6cm}|L{2.6cm}|L{3.7cm}|L{1.6cm}|L{2.2cm}|}
\hline
...
\hline
/predictions/ \newline \{request\_id\} & GET & path: request\_id & PredictionResponse & 200 & 404, 500 \\
\hline
/predictions & GET & query: limit, risk\_level & список PredictionResponse & 200 & 422, 500 \\
\hline
\end{tabular}
\end{table}
